...
def main() -> int:
    ...
    with app.test_client() as client:
        ...
        if "jpeg" not in (icon.content_type or "").lower() and "jpg" not in (icon.content_type or "").lower():
        ...
        if "chatbotfaceicon.png" in chat_text or "chatbotfaceicon.png" in widget:
            failures.append("Test9: PNG参照が残っている")
